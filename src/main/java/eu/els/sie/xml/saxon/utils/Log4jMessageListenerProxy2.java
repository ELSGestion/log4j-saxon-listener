...
public class Log4jMessageListenerProxy2 implements MessageListener2 {

	private static final Logger LOGGER = LoggerFactory.getLogger(Log4jMessageListenerProxy2.class);
